(function($) {
    $.fn.extend({
                ...
                if (opts.accordion == 'LtR') {
                    ...
                    $(LtRBox).on(opts.clickHover, function() {
                        $(this).stop(true, true).animate({
                            width: leftRightW
                        }, opts.timer).siblings().stop(true, true).animate({
                            width: $thisLeftClick
                        }, opts.timer)
                    })
                } else {
        ...
        "marquee": function(options) {
            ...
            return this.each(function() {
                var $this = $(this);
                var lrUlBox = '.ytl_lrLbList',
                    lrLiBox = '.ytl_lrLbList li';
                var tdUlBox = '.ytl_tdLbList',
            ...
            return this.each(function() {
                ...
                $this.find(".ytl_prev").click(function() {
                    ...
                    if (beforeIndex == afterIndex) {
                        ...
                        $this.find(ulLiBox).eq(beforeIndex).css({
                            "z-index": Lenth + 20
                        });
                        $this.find(ulLiBox).eq(afterIndex).css({
                            "z-index": Lenth + 19
                        });
                        clearDiv(afterIndex);
                        s = afterIndex;
                        ...
                        if (afterIndex >= opts.showNum - 2 && afterIndex <= Lenth - opts.showNum + 1) {
                            $(imgOlBox).stop(true).animate({
                                "margin-left": (-afterIndex + 1) * $(clickBox1).outerWidth(true)
                            }, opts.timer / 3)
                            ...
                            $(imgOlBox).stop(true).animate({
                                "margin-left": (-Lenth + opts.showNum) * $(clickBox1).outerWidth(true)
                            }, opts.timer / 3)
                        }
                    } else {
                        if (afterIndex >= opts.showNum - 2 && afterIndex <= Lenth - opts.showNum + 1) {
                            $(imgOlBox).stop(true).animate({
                                "margin-top": (-afterIndex + 1) * $(clickBox1).outerHeight(true)
                            }, opts.timer / 3)
                        } else if (afterIndex < opts.showNum - 2 && afterIndex >= -1) {
                            $(imgOlBox).stop(true).animate({
                                "margin-top": 0
                            ...
                            $(imgOlBox).stop(true).animate({
                                "margin-top": (-Lenth + opts.showNum) * $(clickBox1).outerHeight(true)
                            }, opts.timer / 3)
                        }
                    }
                });
                    ...
                    if (opts.createImg) {
                        if (opts.direction == 'horizontal') {
                            if (s >= opts.showNum - 1 && s <= Lenth - opts.showNum + 1) {
                                $(imgOlBox).stop(true).animate({
                                    "margin-left": (-s + 2) * $(imgOlLiBox).outerWidth(true)
                                }, opts.timer / 3)
                                ...
                                $(imgOlBox).stop(true).animate({
                                    "margin-left": (-Lenth + opts.showNum) * $(imgOlLiBox).outerWidth(true)
                                }, opts.timer / 3)
                            }
                        } else {
                            ...
                            if (s >= opts.showNum - 1 && s <= Lenth - opts.showNum + 1) {
                                $(imgOlBox).stop(true).animate({
                                    "margin-top": (-s + 2) * $(imgOlLiBox).outerHeight(true)
                                }, opts.timer / 3)
                            } else if (s < opts.showNum - 1) {
                                $(imgOlBox).stop(true).animate({
                                    "margin-top": 0
                                ...
                                $(imgOlBox).stop(true).animate({
                                    "margin-top": (-Lenth + opts.showNum) * $(imgOlLiBox).outerHeight(true)
                                }, opts.timer / 3)
                            }
                        }
                    }
                ...
                function fade() {
                    ...
                    $this.find(ulLiBox).animate({
                        'opacity': '0'
                    }, opts.timer * (2 / 3));
                    $this.find(ulLiBox).eq(s).stop(true, true).animate({
                        'opacity': '1'
                    }, opts.timer * (2 / 3));
                    clearDiv(eqNum);
                    initialize()
                    ...
                    switch (ids) {
                        case 1:
                            ...
                            for (var i = 1; i <= opts.divLevelNum; i++) {
                                ...
                                $this.find(ulLiBox).eq(s - 1).find('.ytl_imgActive').eq(i - 1).stop(true).animate({
                                    'left': left
                                }, opts.timer)
                            }
                            break;
                ...
                function allMove(ids, id) {
                    ...
                    switch (ids) {
                        case 1:
                            ...
                            $this.find(ulLiBox).eq(s - 1).stop(true).animate({
                                'left': move + 'px'
                            }, opts.timer * (2 / 3));
                            break;
                        case 2:
                ...
                function initialize() {
                    ...
                    $this.find(ulLiBox).eq(s - 1).css({
                        "z-index": Lenth + 20
                    });
                    $this.find(ulLiBox).eq(s).css({
                        "z-index": Lenth + 19
                    })
                }
                    ...
                    $this.find("ol>li").on(opts.clickHover, function() {
                        ...
                        if (beforeIndex == afterIndex) {
                            ...
                            if (afterIndex >= opts.showNum - 1 && afterIndex <= Lenth - opts.showNum + 1) {
                                $(imgOlBox).stop(true).animate({
                                    "margin-left": (-afterIndex + 2) * $(clickBox1).outerWidth(true)
                                }, opts.timer / 3)
                            ...
                            if (afterIndex >= opts.showNum - 1 && afterIndex <= Lenth - opts.showNum + 1) {
                                $(imgOlBox).stop(true).animate({
                                    "margin-top": (-afterIndex + 2) * $(clickBox1).outerHeight(true)
                                }, opts.timer / 3)
                            } else if (afterIndex < opts.showNum - 1) {
                                $(imgOlBox).stop(true).animate({
                                    "margin-top": 0
                ...
                function clickFade(beforeIndex) {
                    $this.find(ulLiBox).eq(beforeIndex).stop(true, true).animate({
                        'opacity': 0
                    }, opts.timer * (2 / 3))
                }
                    ...
                    switch (ids) {
                        case 1:
                            ...
                            for (var i = 1; i <= opts.divLevelNum; i++) {
                                ...
                                $this.find(ulLiBox).eq(beforeIndex).find('.ytl_imgActive').eq(i - 1).stop(true).animate({
                                    'left': left
                                }, opts.timer)
                            }
                            break;
                ...
                function clickAllMove(ids, id, lrTop, afterIndex, beforeIndex) {
                    ...
                    switch (ids) {
                        case 1:
                            ...
                            (id == 1) ? move = move: move = -move;
                            $this.find(ulLiBox).eq(beforeIndex).stop(true).animate({
                                'left': move + 'px'
                            }, opts.timer * (2 / 3));
                            break;
                        case 2:
        ...
        "multipleRolling": function(options) {
            ...
            return this.each(function() {
                ...
                $this.find(olLiBox).click(function() {
                    ...
                    findUlBox.stop().animate({
                        "margin-left": -liW * opts.showNum * index
                    }, opts.timer / 3)
                });
                ...
                function animationCon() {
                    ...
                    if (opts.moveNum < len) {
                        ...
                        findUlBox.parent().find(olLiBox).removeClass('ytl_pointActive');
                        findUlBox.parent().find(olLiBox).eq(s).addClass('ytl_pointActive');
                        findUlBox.stop(true, true).animate({
                            "margin-left": -liW * opts.moveNum * s
                        }, opts.timer / 3)
                    }
                }
            })
        ...
        "highlight": function(options) {
            ...
            return this.each(function() {
                ...
                function animation() {
                    ...
                    if (index >= $this.find(liBox).length - Math.ceil(opts.showNum / 2)) {
                        index = Math.floor(opts.showNum / 2);
                        $this.find(liBox).removeClass('tstAll');
                        $this.find(liBox).eq(index).addClass('ytl_active');
                        $this.find(listBox).animate({
                            "margin-left": ulL
                        }, 0, function() {
                            $this.find(listBox).animate({
                                "margin-left": -$this.find(liBox).outerWidth(true)
                            }, opts.timer / 2)
                        })
                    } else {
        ...
        "layout": function(options) {
            ...
            return this.each(function() {
                ...
                $this.find(conBox).css({
                    "left": left,
                    "top": top
                });
                $this.find(closeBox).css({
                    "right": left,
                    "top": top
                });
            ...
            return this.each(function() {
                ...
                time = setInterval(function() {
                    for (var i = 0; i < imgTag.length; i++) {
                        ...
                        var imgScale = imginnerWidth / imginnerHeight;
                    ...
                    function large() {
                        imgTag.eq(i).css({
                            "height": '100%',
                            "width": imgScale * boxHeight + 'px',
                            "margin-left": -(imgScale * boxHeight - boxWidth) / 2 + 'px'
                        })
                    }
                    ...
                    function small() {
                        imgTag.eq(i).css({
                            "width": '100%',
                            "height": boxWidth / imgScale + 'px',
                            "margin-top": -(boxWidth / imgScale - boxHeight) / 2 + 'px'
                        })
                    }
                }, 10)
            })
        ...
        "alignTBC": function(options) {
            ...
            return this.each(function() {
                ...
                olBox.css({
                    "margin-left": -Math.abs(ulLiShow - olLiShow) * olLiW + olLiW
                });
                ...
                function moveCon() {
                    ...
                    if (s > oldLen) {
                        ...
                        olBox.css({
                            ...
                            "margin-left": -Math.abs(ulLiShow - olLiShow) * olLiW + olLiW - s * olLiW
                        }, 0);
                        ulBox.css({
                            "margin-left": 0
                        }).stop(true, true).animate({
                        ...
                        olBox.css({
                            "margin-left": -Math.abs(ulLiShow - olLiShow) * olLiW + olLiW - (s + 1) * olLiW
                        }).stop(true, true).animate({
                            "margin-left": -Math.abs(ulLiShow - olLiShow) * olLiW + olLiW - s * olLiW
                        }, 0);
                        ulBox.css({
                            "margin-left": -(s + 1) * ulLiW
                        }).stop(true, true).animate({
                            "margin-left": -s * ulLiW
                        }, 0)
                    } else {
                        olBox.stop(true, true).animate({
                            "margin-left": -Math.abs(ulLiShow - olLiShow) * olLiW + olLiW - s * olLiW
                        }, opts.timer / 2);
                        ulBox.stop(true, true).animate({
                            "margin-left": -s * ulLiW
