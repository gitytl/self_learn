    ...
    $.fn.extend({
        ...
        "highlight": function (options) {
                ...
                return this.each(function () {
                    ...
                    $this.find(listBox).css({"margin-left":ulL});
                    var s=0,time=null;
                    function animation() {
                        s++;
                        ...
                        if(index>=$this.find(liBox).length-Math.ceil(opts.showNum/2)) {
                            ...
                            $this.find(listBox).animate({"margin-left":ulL},0,function () {
                                $this.find(listBox).animate({"margin-left":-$this.find(liBox).outerWidth(true)},opts.timer/2);
                            });
                        }
                        else {
            ...
            return this.each(function () {
                ...
                ulLiBox.on("click", function () {
                    ...
                    if(num>=Math.floor(opts.showNum/2)){
                        ...
                        ulBox.stop(true,true).animate({'left': leftVal},500);
                    }
                });
                var num = 1;
                ...
                function prevNextClick(prevNext) {
                    ...
                    if(num<0){
                        num=0;
                        ulBox.stop(true,true).animate({'left': 0},500);
                    }
                    if(num>=Math.floor(opts.showNum/2)){
                        var leftVal="";
                        if(-(num-Math.floor(opts.showNum/2))*ulLiBox.outerWidth(true)<-(ulLiBox.length-opts.showNum)*ulLiBox.outerWidth(true)){
            ...
            return this.each(function () {
                ...
                function moveCon() {
                    ...
                    if(s>oldLen){
                        ...
                        olBox.stop(true,true).animate({"margin-left":-Math.abs(ulLiShow-olLiShow)*olLiW+olLiW-s*olLiW},opts.timer/2);
                        ulBox.stop(true,true).animate({"margin-left":-s*ulLiW},opts.timer/2);
                    }
                }
            });
        }
