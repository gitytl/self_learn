    ...
    $.fn.extend({
        ...
        "multipleRolling": function (options) {
            ...
            return this.each(function () {
                ...
                $this.find(olLiBox).click(function () {
                    ...
                    $(this).addClass("on").siblings().removeClass("on");
                    findUlBox.stop(true).animate({"margin-left":-liW*opts.showNum*index},opts.timer/3);
                });
        ...
        "lilyWindow": function (options) {
            ...
            return this.each(function () {
                ...
                //分割图片
                //基本参数
                var createSize=68,cNum=0,s=0,flag=flag1=true;
                ...
                titBox.eq(0).stop(true).animate({"bottom":titBox.height()},opts.timer/3);
                ...
                function c(kind,src) {
                    ...
                    createImg.find("div").each(function (index) {
                        ...
                        var _t_l={"top":parseInt(index/lNum)*createH, "left":parseInt(index%lNum)*createW};
                        //type=1
                        var _1t={"top":createH*index},
                            _1b={"bottom":createH*(divL-index-1)},
                            _1l={"left":0},
                            _1r={"right":0},
                            _1w_l={"width":"100%", "left":"0"},
                            _1w_o={"width": "100%", "opacity":1},
                            _1l_b={"left": 0, "background-position":"top -"+createH*index+"px left"},
                            _1r_b={"right": 0, "background-position":"top -"+createH*index+"px right"},
                            _1h_t={"height":createH, "top":createH*index},
                            _1h_o={"height":createH, "opacity": 1};
                        //type=2
                        var _2l={"left":createW*index},
                            _2r={"right":createW*(divL-index-1)},
                            _2t={"top":0},
                            _2b={"bottom":0},
                            _2w_l={"width":createW, "left":createW*index},
                            _2w_o={"width":createW, "opacity": 1},
                            _2t_b={"top": 0, "background-position":"left -"+createW*index+"px top"},
                            _2b_b={"bottom": 0, "background-position":"left -"+createW*index+"px bottom"},
                            _2h_t={"height":"100%", "top":"0"},
                            _2h_o={"height":"100%", "opacity":1};
                        //type=3
                        var _3h={"height": createH},
                            _3h_o={"height":createH, "opacity": 1},
                            _3t_r={"top": parseInt(index / lNum) * createH, "right": parseInt((divL - index - 1) % lNum) * createW},
                            _3w={"width":createW},
                            _3w_o={"width": createW, "opacity": 1},
                            _3b_l={"bottom":parseInt((divL-index-1)/lNum)*createH, "left":parseInt(index%lNum)*createW};

                        //kind和type：1，1上下横条动画；1，2左右竖条动画
                        if(kind==1&&(type==1||type==2)){
                            var wl_ht=t_l=b_r=ho_wo={};
                            if(type==1){
                                wl_ht=_1w_l, t_l=_1t, b_r=_1b, ho_wo=_1h_o;
                            }
                            if(type==2){
                                wl_ht=_2h_t, t_l=_2l, b_r=_2r, ho_wo=_2w_o;
                            }
                            _this.css(wl_ht);
                            (flag)?_this.css(t_l):_this.css(b_r);
                            _this.stop(true).animate(ho_wo,opts.timer/3);
                        }
                        //横条竖条交叉动画
                        if(kind==2&&(type==1||type==2)){
                            var ht_wl=l_t=r_b=wo_ho={};
                            if(type==1){
                                ht_wl=_1h_t, l_t=_1l, r_b=_1r, wo_ho=_1w_o;
                            }
                            if(type==2){
                                ht_wl=_2w_l, l_t=_2t, r_b=_2b, wo_ho=_2h_o;
                            }
                            _this.css(ht_wl);
                            (index%2==1)?_this.css(l_t):_this.css(r_b);
                            _this.stop(true).animate(wo_ho,opts.timer/3);
                        }
                        //横条竖条层次动画
                        if(kind==3&&(type==1||type==2)){
                            if(type==1){
                                var _w=(flag)?index*createH:(divL-1-index)*createH;
                                var lb_rb={};
                                if(_random==1) lb_rb=_1l_b;
                                if(_random==2) lb_rb=_1r_b;
                                _this.css({
                                    "width": _w,
                                    "height": createH,
                                    "top": createH * index,
                            ...
                            if(type==2){
                                ...
                                var tb_bb={};
                                if(_random==1) tb_bb=_2t_b;
                                if(_random==2) tb_bb=_2b_b;
                                _this.css({
                                    "width": createW,
                                    "height": 0,
                                    "left": createW * index,
                        ...
                        //kind和type：1，3左右方格动画；2，3上下方格动画
                        if((kind==1&&type==3)||(kind==2&&type==3)){
                            ...
                            if(index%2==1){
                                _this.stop(true).animate(wo_ho,opts.timer/6);
                            }else {
                                _this.stop(true).animate(reset,opts.timer/6,function () {
                                    _this.stop(true).animate(wo_ho,opts.timer/6);
                                });
                            }
                        }
                ...
                function a() {
                    if(s>len-1){
                        s=0;
                        imgBox.parent().stop(true).animate({"margin-left":0},opts.timer/3);
                    }
                    if(s<0){
                        s=len-1;
                        imgBox.parent().stop(true).animate({"margin-left":-(s-smallShow)*imgBox.outerWidth(true)},opts.timer/3);
                    }
                    var random=parseInt(Math.random()*opts.kind+1),
                        imgSrc=liBox.eq(s).find("img").attr("src");
                    c(random,imgSrc);
                    titBox.stop(true).animate({"bottom":0},opts.timer/6);
                    setTimeout(function () {
                        liBox.hide().eq(s).show();
                        titBox.eq(s).stop(true).animate({"bottom":titBox.height()},opts.timer/6);
                        pointBox.removeClass("on").eq(s).addClass("on");
                        imgBox.removeClass("on").eq(s).addClass("on");
                        var smallShow=Math.floor($this.outerWidth(true)/imgBox.outerWidth(true))-1;
                        if(s>smallShow-1){
                            imgBox.parent().stop(true).animate({"margin-left":-(s-smallShow)*imgBox.outerWidth(true)},opts.timer/3);
                        }
                    },opts.timer/3);
