    ...
    $.fn.extend({
        ...
        "banner": function (options) {
            ...
            return this.each(function () {
                ...
                pointBox.find('li').eq(0).addClass('ytl_pointActive');
                ...
                function mytime() {
                    ...
                    imgBox.find('li').stop(true,true).animate({'opacity': '0'}, opts.timer*2/3);
                    imgBox.find('li').eq(s).stop(true,true).animate({'opacity': '1'}, opts.timer*2/3);
                    pointBox.find('li').eq(s).addClass('ytl_pointActive').siblings().removeClass('ytl_pointActive');
                }
                time = setInterval(function () {
                    s++;
                    mytime();
