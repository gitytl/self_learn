    ...
    $.fn.extend({
        ...
        "lilyWindow": function (options) {
            ...
            return this.each(function () {
                ...
                titBox.eq(0).stop().animate({"bottom":titBox.height()},opts.timer/3);
                ...
                function c(kind,src) {
                    ...
                    createImg.find("div").each(function (index) {
                        ...
                        if(kind==1&&(type==1||type==2)){
                            ...
                            if(type==1){
                                wl_ht={"width":"100%", "left":"0"};
                                t_l={"top":createH*index};
                                b_r={"bottom":createH*(divL-index-1)};
                                ho_wo={"height":createH, "opacity": 1};
                            }
                            if(type==2){
                                wl_ht={"height":"100%", "top":"0"};
                                t_l={"left":createW*index};
                                b_r={"right":createW*(divL-index-1)};
                                ho_wo={"width":createW, "opacity": 1};
                            }
                            _this.css(wl_ht);
                            (flag)?_this.css(t_l):_this.css(b_r);
                            _this.stop().animate(ho_wo,opts.timer/3);
                        }
                        //横条竖条交叉动画
                        if(kind==2&&(type==1||type==2)){
                            var ht_wl=l_t=r_b=wo_ho={};
                            if(type==1){
                                ht_wl={"height":createH, "top":createH*index};
                                l_t={"left":0};
                                r_b={"right":0};
                                wo_ho={"width": "100%", "opacity":1};
                            }
                            if(type==2){
                                ht_wl={"width":createW, "left":createW*index};
                                l_t={"top":0};
                                r_b={"bottom":0};
                                wo_ho={"height":"100%", "opacity":1};
                            }
                            _this.css(ht_wl);
                            if(index%2==1){
                                _this.css(l_t);
                            ...
                            _this.stop().animate(wo_ho,opts.timer/3);
                        }
                        //横条竖条层次动画
                        ...
                        if((kind==1&&type==3)||(kind==2&&type==3)){
                            ...
                            tl={"top":parseInt(index/lNum)*createH, "left":parseInt(index%lNum)*createW};

                            if(kind==1) {
                                h_w = {"height": createH};
                                tr_lb = {"top": parseInt(index / lNum) * createH, "right": parseInt((divL - index - 1) % lNum) * createW};
                                wo_ho = {"width": createW, "opacity": 1};
                                reset = {"width": 0, "opacity": 0};
                            }
                            if(kind==2) {
                                h_w={"width":createW};
                                tr_lb={"bottom":parseInt((divL-index-1)/lNum)*createH, "left":parseInt(index%lNum)*createW};
                                wo_ho={"height":createH, "opacity": 1};
                            ...
                            if(index%2==1){
                                _this.stop().animate(wo_ho,opts.timer/6);
                            }else {
                                _this.stop().animate(reset,opts.timer/6,function () {
                                    _this.stop().animate(wo_ho,opts.timer/6);
                                });
                            }
                        }
                ...
                function a() {
                    ...
                    if(s>len-1){
                        s=0;
                        imgBox.parent().stop(true,true).animate({"margin-left":0},opts.timer/3);
                    }
                    var random=parseInt(Math.random()*opts.kind+1),
                        imgSrc=liBox.eq(s).find("img").attr("src");
                    c(1,imgSrc);
                    titBox.stop().animate({"bottom":0},opts.timer/3);
                    setTimeout(function () {
                        liBox.hide().eq(s).show();
                        titBox.eq(s).stop().animate({"bottom":titBox.height()},opts.timer/3);
                        ...
                        if(s>smallShow-1){
                            imgBox.parent().stop(true,true).animate({"margin-left":-(s-smallShow)*imgBox.outerWidth(true)},opts.timer/3);
                        }
                    },opts.timer/3);
                    //产生不重复随机排序数组
