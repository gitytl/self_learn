    ...
    $.fn.extend({
        ...
        "lilyWindow": function (options) {
            ...
            return this.each(function () {
                ...
                function animation() {
                    ...
                    if(opts.createImg) {
                        if(s>=opts.showNum-1&&s<=Lenth-opts.showNum+1){
                            $(imgOlBox).stop(true).animate({"margin-left":(-s+1)*$(imgOlLiBox).outerWidth(true)},opts.timer/3);
                        }
                        else if(s<opts.showNum-1){
                            $(imgOlBox).css({"margin-left":0});
                        }
                    }
                }
                var lrTop=true;
                ...
                /*点点的点击或移入*/
                function clickHover() {
                    var clickBox="",activeClassName="",activeClass="";
                    if(opts.createPoint) {
                    ...
                    if(opts.createImg) {
                        clickBox=".ytl_smallImgList>li";
                        activeClassName="ytl_smallImgActive";
                        activeClass=".ytl_smallImgActive";
                    }
                    var arr = [],lrTop=true;
                    ...
                    $this.find(clickBox).on(opts.clickHover,function () {
                        ...
                        if(opts.createImg) {
                            if($(this).index()+1>=opts.showNum-1&&$(this).index()<=Lenth-opts.showNum+1){
                                $(this).parent().stop(true).animate({"margin-left":(-$(this).index()+1)*$(this).outerWidth(true)},opts.timer/3);
                            }
                            else if(s<opts.showNum-1){
                                $(imgOlBox).css({"margin-left":0});
                            }
