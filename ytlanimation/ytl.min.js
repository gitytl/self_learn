        ...
        "lilyWindow": function (options) {
            ...
            return this.each(function () {
                ...
                function animation() {
                    ...
                    switch (parseInt(arr[index])) {/*switch (parseInt(arr[index])) {*/
                        case 1:
                            fade();
                            break;
                        case 2:
