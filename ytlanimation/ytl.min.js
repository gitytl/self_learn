        ...
        "multipleRolling": function (options) {
            ...
            return this.each(function () {
                ...
                var divBox='.ytl_listBox',
                    ...
                    olLiBox='.ytl_pointLists li';
                initialize(0);
                (opts.group)?((opts.divLevelNum>1)?opts.showNum=opts.moveNum:opts.moveNum=opts.showNum):opts.moveNum=1;
                ...
                function animation() {
                    ...
                    if(opts.moveNum<len){
                        var maxNum='';
                        (opts.group)?((opts.divLevelNum>1)?maxNum=Math.ceil(len/opts.moveNum/opts.divLevelNum)-2:maxNum=Math.ceil(len/opts.moveNum)-2):maxNum=len-opts.showNum-1;
                ...
                function initialize(num) {
                    ...
                    if(!opts.group||len/opts.showNum<=1||len/opts.moveNum/opts.divLevelNum<=1) {
