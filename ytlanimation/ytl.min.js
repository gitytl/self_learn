        ...
        "multipleRolling": function (options) {
            ...
            return this.each(function () {
                ...
                function animation() {
                    ...
                    if(opts.moveNum<len){
                        var maxNum='';
                        (opts.group)?maxNum=Math.ceil(len/opts.moveNum)-2:maxNum=len-opts.showNum-1;
                ...
                function initialize(num) {
                    ...
                    var divW = len * (findUlBox.find('li').outerWidth(true));
                    findUlBox.width(divW);
                    if(!opts.group||len/opts.showNum<=1) {
        ...
        if (opts.createPoint) {
            $this.find('ul').each(function (index) {
                ...
                len=ulBox.find('li').length;
                    ...
                    for(var i=0;i<len/opts.moveNum;i++){
